...
public class CategoryService {
    ...
    @Transactional
    public Category saveRegularProduct(Long categoryId, Category category) {
        // Checa se categoria recebida tem materiais.
        categoryRepository.save(category);
        if (category.getProducts() != null && !category.getProducts().isEmpty()) {
            category.getProducts().forEach(product -> {
                // Checa se produto tem materiais
                if (product.getMaterials() != null && !product.getMaterials().isEmpty()) {
                    // Cria material do produto.
                    productService.createProductMaterial(product.getMaterials());
                }
                // Checa se produto tem tags.
                if (product.getTags() != null && !product.getTags().isEmpty()) {
                    // Cria tag do produto.
                    productService.createProductTag(product.getTags());
                }
                // Salva produto.
